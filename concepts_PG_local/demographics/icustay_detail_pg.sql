...
, (date_part('year', adm.admittime) - pat.anchor_year) + pat.anchor_age AS admission_age
, adm.ethnicity
...
, ROUND(cast(extract (EPOCH FROM (ie.outtime - ie.intime)/3600) as numeric), 2) as los_icu

--, age(ie.outtime, ie.intime) as los_icu  --works, but long time
