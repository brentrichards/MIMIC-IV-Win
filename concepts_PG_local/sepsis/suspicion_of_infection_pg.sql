...
(
  ...
  from mimiciv.antibiotic_mv abx
)
, me as
(
...
(
  ...
  LEFT JOIN me me72
    ...
    (
      ...
      and ab_tbl.antibiotic_time <= DATE(me72.charttime + INTERVAL '72 HOUR') 
      )
      OR
      (
      ...
      and antibiotic_date <= DATE(me72.chartdate + INTERVAL '3 DAY')
      )
    )
)
, ab_then_me AS
(
  ...
  LEFT JOIN me me24
    ...
    (
      ...
      and ab_tbl.antibiotic_time >= DATE(me24.charttime - INTERVAL '24 HOUR')  
      ...
      and ab_tbl.antibiotic_date >= DATE(me24.chartdate - INTERVAL '1 DAY')
