...
CREATE MATERIALIZED VIEW mimiciv.first_day_vitalsign_mv AS
...
LEFT JOIN mimiciv.vitalsign_mv ce
    ON ie.stay_id = ce.stay_id
    AND ce.charttime >= DATE(ie.intime - INTERVAL '6 HOURS')
    AND ce.charttime <= DATE(ie.intime + INTERVAL '1 DAY')
