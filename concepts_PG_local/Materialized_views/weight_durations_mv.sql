...
CREATE materialized view mimiciv.weight_durations_mv AS
...
(
  SELECT 
    ...
    , case when wt_stg1.weight_type = 'admit' and wt_stg1.rn = 1
        then DATE(ie.intime - INTERVAL '2 HOURS')
...
(
  select ie.stay_id
    ...
    , DATE(ie.intime - INTERVAL '2 HOURS') as starttime
