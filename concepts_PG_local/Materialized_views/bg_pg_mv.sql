...
CREATE materialized view mimiciv.bg_mv AS
...
left join stg_spo2 s1
  ...
  and s1.charttime between DATE(bg.charttime - INTERVAL '2 HOURS') and bg.charttime
...
left join stg_fio2 s2
  ...
  and s2.charttime between DATE(bg.charttime - INTERVAL '4 HOURS') and bg.charttime
